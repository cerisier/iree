...
//
// Pins the input-side `shape_cast` between the 2-D CPU tile type
// (`<32x4>`) and the swizzle's full distributed N-D shape
// (`<2x16x4x1>`), and the inverse `shape_cast` in the reassemble body.
